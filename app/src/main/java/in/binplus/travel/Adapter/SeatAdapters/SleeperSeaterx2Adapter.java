 ...
 */
public class SleeperSeaterx2Adapter extends RecyclerView.Adapter<SleeperSeaterx2Adapter.ViewHolder> {
    Activity activity;
    int seats;
    String type="";
    int pos=-1;
    ...
    public SleeperSeaterx2Adapter(Activity activity, int seats, String type, ArrayList<String> rm_list, ArrayList<String> resList, ArrayList<String> femaleList) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view= LayoutInflater.from(activity).inflate(R.layout.row_sleeper_seaterx2_lower,null);
...
////                }
    ...
    private void updateintent() {
        ...
        updates.putExtra("deck", "sleeperseaterx2");
