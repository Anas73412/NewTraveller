...
public class SemiSleeper3x2Adapter extends RecyclerView.Adapter<SemiSleeper3x2Adapter.ViewHolder> {
    ...
    public SemiSleeper3x2Adapter(Activity activity, ArrayList<String> rm_list, int seats) {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, final int position) {
        ...
        for(int i=0; i<rm_list.size();i++)
        {
            ...
            if(position == pos)
            {
                ...
                {
                    holder.seat_5.setImageTintList( ColorStateList.valueOf( activity.getResources().getColor(R.color.orange) ) );
                }
            }
            else {
            ...
            public void onClick(View v) {
                ...
                if(module.getExistSeat( rm_list, module.getRowData(position)+"5"))
                {
                    ...
                    if (module.getSeatDeseletct( seat_list, module.getRowData( position ) + "5" )) {
                        holder.seat_5.setImageTintList( ColorStateList.valueOf( activity.getResources().getColor( R.color.dark_gray) ) );
                        seat_list.remove( module.getSeatListPosition( seat_list, module.getRowData( position ) + "5" ) );

                    } else {
                        holder.seat_5.setImageTintList( ColorStateList.valueOf( activity.getResources().getColor( R.color.green_switch ) ) );
